          ...
          <div className="grid gap-10 lg:grid-cols-[1.12fr_0.88fr] lg:items-start">
            ...
            >
              <p className="text-[1.08rem] font-light leading-[1.42] text-[#E6E8EB]/72 md:text-[1.2rem]">
                Boulai builds Scientific AI for biopharma R&D: models and agents designed around the scientific method
                and human causal reasoning, from data exploration to hypothesis generation and causal theory testing.
                We are designing a new way of doing science with AI—rigorous, inspectable, and reproducible at scale.
              </p>
